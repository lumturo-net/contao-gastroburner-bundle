 ...
 */
class GastroburnerPersonalDataModule extends \Contao\Module
{
	...
	public function generate()
	{
		if (TL_MODE == 'BE')
		{
			...
			$objTemplate->wildcard = '### ' . Utf8::strtoupper($GLOBALS['TL_LANG']['FMD']['gastroburnerpersonaldata'][0]) . ' ###';
...
class_alias(GastroburnerPersonalDataModule::class, 'GastroburnerPersonalDataModule');
