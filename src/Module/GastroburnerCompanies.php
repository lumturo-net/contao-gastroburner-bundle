...
class GastroburnerCompanies extends \Contao\Module
{
    ...
    protected function compile()
    {
        ...
        $arrFields = ['id', 'company', 'street', 'postal', 'city', 'lat', 'lon', 'shortname', 'shortdesc', 'restaurant', 'cook', 'kitchen', 'system', 'hotelcleaner', 'hotelmanager', 'gastro', 'companyLogo', 'website'];
